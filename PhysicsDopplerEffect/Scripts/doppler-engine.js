(function (global) {
    ...
    function Simulation(settings) {
        ...
        this.representativeWaveInterval = Number(this.settings.RepresentativeWaveInterval || this.settings.representativeWaveInterval || 0);
        this.baseFrequency = Number(this.settings.SourceFrequency || this.settings.sourceFrequency || 180);
    ...
    Simulation.prototype.emitRepresentativeWavefronts = function () {
        ...
        // Presentation views can request a slower readable emission cadence.
        // The complete simulation clock is still scaled consistently by callers,
        // so source motion and wave expansion keep the same geometry.
        var interval = this.representativeWaveInterval > 0 ? this.representativeWaveInterval : stride / frequency;
