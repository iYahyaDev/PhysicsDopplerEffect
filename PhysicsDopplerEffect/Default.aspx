...
<asp:Content ID="HomeHead" ContentPlaceHolderID="HeadContent" runat="server">
    <meta name="description" content="Interactive Doppler effect lab and editable presentation platform for classroom physics." />
</asp:Content>
<asp:Content ID="HomeContent" ContentPlaceHolderID="MainContent" runat="server">
    <section class="home-grid">
        <div class="home-intro">
            ...
            <div class="action-row">
                <a class="primary-link" href="Presenter.aspx?id=doppler-main" data-text-ar="ابدأ العرض" data-text-en="Start presentation">ابدأ العرض</a>
                <a class="secondary-link" href="PresentationEditor.aspx?id=doppler-main" data-text-ar="تحرير العرض" data-text-en="Edit presentation">تحرير العرض</a>
                <a class="secondary-link" href="Lab.aspx" data-text-ar="افتح المختبر الكامل" data-text-en="Open full laboratory">افتح المختبر الكامل</a>
                <a class="secondary-link" href="Applications.aspx" data-text-ar="افتح التطبيقات" data-text-en="Open applications">افتح التطبيقات</a>
            </div>
        </div>
    ...
    <section class="module-grid compact-modules" aria-label="Main site areas">
        <article class="module-card">
            <img src="Assets/motorcycle-source.png" alt="" aria-hidden="true" />
        ...
        <article class="module-card">
            <img src="Assets/custom-listener.png" alt="" aria-hidden="true" />
