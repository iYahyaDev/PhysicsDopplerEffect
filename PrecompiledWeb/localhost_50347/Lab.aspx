        ...
        <aside class="lab-panel">
            <section class="metrics-grid" aria-label="Live measurements">
                <article class="metric-card">
                    ...
                    <strong id="emitValue" class="metric-value">90 Hz</strong>
                </article>
                <article class="metric-card">
                    <span data-text-ar="دورات المحرك" data-text-en="Engine RPM">دورات المحرك</span>
                    <strong id="engineRpmValue" class="metric-value">5400 RPM</strong>
                </article>
                <article class="metric-card status-card">
                    <span data-text-ar="المسموع عند أ" data-text-en="Observed at A">المسموع عند أ</span>
                    <strong id="observedAValue" class="metric-value">90 Hz</strong>
                </article>
                <article class="metric-card" id="listenerBMetric">
                    ...
                    <strong id="observedBValue" class="metric-value">90 Hz</strong>
                </article>
                <article class="metric-card">
            ...
            <section class="control-panel" aria-label="Simulation controls">
                ...
                <label class="slider-field">
                    ...
                    <input id="sourceFrequency" type="range" min="40" max="220" step="1" value="90" />
                    <output id="sourceFrequencyOut" class="metric-value">90 Hz</output>
                </label>
                <label class="slider-field">
                    <span data-text-ar="سرعة الدراجة النارية" data-text-en="Motorcycle speed">سرعة الدراجة النارية</span>
