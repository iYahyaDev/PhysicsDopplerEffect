(function (global) {
    ...
    function DopplerRenderer(canvas) {
        ...
        this.images = {
            motorcycle: loadImage("Assets/motorcycle-rider.png"),
            listener: loadImage("Assets/listener-person.png")
        };
        this.resize();
    }
    ...
    var SPRITES = {
        motorcycle: {
            worldHeight: 23,
            visualAnchor: { x: 0.5, y: 0.93 },
            acousticPoint: { x: 0.48, y: 0.67 }
        },
        listener: {
            worldHeight: 25,
            visualAnchor: { x: 0.55, y: 0.96 },
            acousticPoint: { x: 0.62, y: 0.18 }
        }
    };
